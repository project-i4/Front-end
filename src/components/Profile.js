    ...
    fetch(url)
      ...
      .then(user => {
        ...
        user.businesses.forEach(business =>
          experience.push(business.experience)
        );
        user.businesses.forEach(business => businesses.push(business.name));

        // experience = experience.slice(0, -2);
        // businesses = businesses.slice(0, -2);
        console.log(user);
    ...
    if (this.state.edite)
      return (
        <div className="container" style={{ marginTop: "20px" }}>
          ...
          >
            <button
              onClick={() => this.setState({ edite: false })}
      ...
      return (
        <div className="prof">
          <div className="container" style={{ marginTop: "20px" }}>
            ...
            >
              <button
                onClick={() => this.setState({ edite: true })}
                style={{ alignSelf: "right" }}
                className="btn btn-primary"
              >
                Edite Profile
          ...
          <div className="container" style={{ marginTop: "20px" }}>
            <div className="row">
              ...
              <Card style={{ width: "21rem", margin: "10px" }}>
                <Card.Body>
                  <Card.Title>{this.state.businesses[0]}</Card.Title>
                  <Card.Text>{this.state.experience[0]}</Card.Text>
                  {/* {aaa = `/individual/${card}`} */}

                  <Link to={`/individual/`}>ii</Link>
                </Card.Body>
              </Card>
            </div>
          </div>
